<template>
  ...
  >
    ...
    <template slot="isDelete" slot-scope="isDelete">
      <a-tag v-if="isDelete === 'UNDELETED'" color="#1890FF">启用</a-tag>
      <a-tag v-else-if="isDelete === 'DELETED'" color="#FFCE44">禁用</a-tag>
    </template>
...
<script>
export default {
  courseCategoryName: "CourseCategoryTable",
  props: {
    currentPage: {
      type: Number,
      default: 0,
    ...
    getColumns() {
      ...
      const columns = [
        ...
        },
        {
          ...
          filters: [
            { text: "启用", value: "UNDELETED" },
            { text: "禁用", value: "DELETED" },
          ],
