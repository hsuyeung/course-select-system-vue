  ...
  >
    ...
    >
      <a-form-model-item
        ...
        prop="articleId"
      >
        <a-select v-model="data.articleId" default-value="请选择分类" style="width:100%">
...
<script>
  ...
  import {getArticlePage, updateSwiper} from "network/swiper";
      ...
      save() {
        this.$refs.form.validate(valid => {
          if (valid) {
            ...
            updateSwiper(this.data).then(res => {
              if (res.code === 20000) {
